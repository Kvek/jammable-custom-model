...
interface UseFormFieldInterface {
...
const useFormField = (): UseFormFieldInterface => {
...
>(({ className, ...props }, ref) => {
  ...
  return <Label className={cn(error && "text-primary/80", className)} htmlFor={formItemId} ref={ref} {...props} />;
});
